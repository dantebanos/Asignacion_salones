...
public class VistaInstrucciones extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        paneBackground.setPreferredSize(new java.awt.Dimension(830, 2130));
        paneBackground.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblImagen.setIcon(new javax.swing.ImageIcon("C:\\imgsistemasalones\\paso2.png")); // NOI18N
        paneBackground.add(lblImagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, -1, 1990));

        jSeparator1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        paneBackground.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 10, 20, 2100));

        jSeparator3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        paneBackground.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 20, 2100));
        ...
        paneBackground.add(btnAceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 2060, 250, 40));
